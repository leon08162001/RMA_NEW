<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucWarrantyOrderSNView.ascx.vb" Inherits="ascx_ucWarrantyOrderSNView" %>

<asp:Panel ID="UI_panel" runat="server" Width="300px" style="display:none;position:absolute">
    <div align="center">
    <fieldset class = "form_div" align="top" style="width: 100%">
    <table id="table2" width="100%" align="center" border="0" cellspacing="1" >
        <tr class="default">
            <td align="left">
                <asp:Label ID="lblTitle" runat ="server" Text="Serial Number List"></asp:Label>
            </td>
        </tr>
                ...
                <div align="center">
                    <asp:GridView ID="UI_dvAddress" runat ="server" Width = "100%" CellPadding ="0" CellSpacing ="1" border="0" CssClass="default" AutoGenerateColumns="False" AllowPaging="true" PagerSettings-Mode="Numeric"  >
                        ...
                        <asp:TemplateField HeaderText="SerialNumber">
                             ...
                             <ItemTemplate>
                                    <asp:Label runat="server" ID="lblSerialNumber" Text='<%# Eval("wats_sn") %>'></asp:Label>
                             </ItemTemplate>
                          </asp:TemplateField>        
                        </Columns> 
