<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProductInformation_05.aspx.vb" Inherits="ProductInformation_05" %>
        ...
        <div class="erma-window-background erma-window-newRequest-printRepair-background">
            <div class="erma-window-box" style="width: 100%; height: 100%;">
                <div class="erma-box-div">
                    <div class="erma-image-cancel" onclick="window.parent.Close_windows();window.parent.Location_Reload_windows();">
                        <img src="../images_new/cancel.svg" />
                    </div>
                </div>
                <asp:Panel ID="Panel1" runat="server">
                    <div class="erma-note-serviceCenter">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Label ID="NoteLab" runat="server" Text=""></asp:Label>
