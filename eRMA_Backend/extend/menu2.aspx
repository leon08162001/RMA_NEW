...
<!--
<li>
 <a href="extendwarr.asp?userno=<%=Session("_UserID")%>" target="bodyFrame">Warranty Extend</a>   
</li>
-->
<li>
 <a href="oeb_reason_add.asp?userno=<%=Session("_UserID")%>" target="bodyFrame">Reason Maintain</a>   
</li>
</ul>
    </form>
</body>
