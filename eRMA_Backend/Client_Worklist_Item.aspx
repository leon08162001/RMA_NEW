<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Client_Worklist_Item.aspx.vb" Inherits="Client_Worklist_Item" Title="Untitled Page" %>
                                ...
                                <td width="99%" align="left" class="default">
                                    ...
                                    <asp:GridView ID="UI_dvRequest" runat="server" Width="100%" CellPadding="0" CellSpacing="1" border="0" CssClass="default" AutoGenerateColumns="False" AllowPaging="true" PagerSettings-Mode="Numeric">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="LaborCost" HeaderText="125_Labor Cost" HeaderStyle-Width="8%" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                                            <asp:BoundField DataField="MaterialCost" HeaderText="126_Material Cost" HeaderStyle-Width="8%" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
