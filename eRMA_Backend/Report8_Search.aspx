<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Report8_Search.aspx.vb" Inherits="Report8_Search" Title="Untitled Page" %>
                            ...
                            <div align="center">
                                <asp:GridView ID="UI_dvReport" runat="server" ShowFooter="true" Width="100%" CellPadding="0" CellSpacing="1" border="0" CssClass="default" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="FAR_REASON" HeaderText="137_Category" HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="left"></asp:BoundField>
