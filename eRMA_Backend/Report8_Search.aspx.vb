...
#End Region
    ...
    Private Sub setControls()
        ...
        Me.UI_lblTittle.Text = _oLanguage.getText("Report", "008", ctlLanguage.eumType.Tag)
    ...
    Private Sub QueryData(ByVal iPageIndex As Integer)
        ...
        dtReport = ctlReport.QueryFailureReason(Session("_CustomerID").ToString().Trim(), ModelNo, Warranty, Repair, Status, fdate, edate, "FAR_NO asc, RMAD_MODELNO asc")
        '        dtReport.Columns.Add("ID", System.Type.GetType("System.Int16"))
    ...
    Private Sub ArrangementData(ByVal dvReport As DataView)
        ...
        dvReport.Sort = "FAR_NO asc, RMAD_MODELNO asc"
        For i = 0 To dvReport.Count - 1
            Dim FAR_NO As String = dvReport(i)("FAR_NO").ToString().Trim()
            ...
            If i = 0 Then
                ...
                dvReport(i)("isShow") = 1
            Else
                If sGroupBY.ToString().ToLower() <> FAR_NO.ToLower() Then
                    dvReport(i)("isShow") = 1
                    sGroupBY = FAR_NO
                End If
            End If
        ...
        sGroupBY = Nothing
        dvReport_Tmp.Sort = "FAR_NO asc, RMAD_MODELNO asc"
        For i = 0 To dvReport_Tmp.Count - 1
            Dim FAR_NO As String = dvReport_Tmp(i)("FAR_NO").ToString().Trim()
            ...
            Else
                If sGroupBY.ToString().ToLower() <> FAR_NO.ToLower() Then
                    ...
                    dr("FAR_NO") = sGroupBY.ToString.Trim()
                    dr("RMAD_MODELNO") = "zzz"
                    dr("MODELNAME") = _oLanguage.getText("Report", "141", ctlLanguage.eumType.Tag)
    ...
    Private Sub Request_DataBind(ByVal dvReport As DataView, ByVal iPageIndex As Integer)
        ...
        dvReport.Sort = "FAR_NO asc, isShow asc"
    ...
    Protected Sub UI_dvReport_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles UI_dvReport.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.Header Then
            e.Row.Cells(1).Text = _oLanguage.getText("Report", "136", ctlLanguage.eumType.Tag)
            e.Row.Cells(2).Text = _oLanguage.getText("Report", "137", ctlLanguage.eumType.Tag)
            e.Row.Cells(3).Text = _oLanguage.getText("Report", "138", ctlLanguage.eumType.Tag)
            e.Row.Cells(4).Text = _oLanguage.getText("Report", "139", ctlLanguage.eumType.Tag)
            e.Row.Cells(5).Text = _oLanguage.getText("Report", "140", ctlLanguage.eumType.Tag)
        End If

        If e.Row.RowType = DataControlRowType.DataRow Then
            Dim UI_MODELNAME As Label = e.Row.FindControl("UI_MODELNAME")
            ...
            Select Case UI_isShow.Text.Trim()
                ...
                Case "3"
                    ...
                    UI_MODELNAME.Text = UI_MODELNAME.Text.Trim() & "&nbsp;&nbsp;"
            End Select
        End If
