...
Public Class Common
    ...
    Public Function ConvertToItemStatusText(ByVal Status As Integer, ByVal RMAD_ID As String) As String
        ...
        Select Case Status
            Case 0
                retval = _oLanguage.getText("RMA2", "108", ctlLanguage.eumType.Tag)
            Case 10
                retval = _oLanguage.getText("RMA2", "072", ctlLanguage.eumType.Tag) 'Requested
            Case 20
                retval = _oLanguage.getText("RMA2", "073", ctlLanguage.eumType.Tag) 'Received

            Case 30 'WIP
                retval = _oLanguage.getText("RMA2", "074", ctlLanguage.eumType.Tag) 'WIP

            Case 35
                retval = _oLanguage.getText("RMA2", "075", ctlLanguage.eumType.Tag) 'Quoted

            Case 40
                retval = _oLanguage.getText("RMA2", "076", ctlLanguage.eumType.Tag)'Sales Quoted
            ...
            Case 60
                retval = _oLanguage.getText("RMA2", "078", ctlLanguage.eumType.Tag) 'Repaired

            Case 70
                retval = _oLanguage.getText("RMA2", "079", ctlLanguage.eumType.Tag) 'Noticed

            Case 90
                retval = _oLanguage.getText("RMA2", "080", ctlLanguage.eumType.Tag) 'Closed
    ...
    Public Sub getItemStatus(ByVal cboStatus As DropDownList)
        ...
        oListItem = New ListItem
        oListItem.Text = _oLanguage.getText("RMA2", "072", ctlLanguage.eumType.Tag)
        oListItem.Value = "10"
        cboStatus.Items.Add(oListItem)

        oListItem = New ListItem
        oListItem.Text = _oLanguage.getText("RMA2", "073", ctlLanguage.eumType.Tag)
        oListItem.Value = "20"
        cboStatus.Items.Add(oListItem)

        oListItem = New ListItem
        oListItem.Text = _oLanguage.getText("RMA2", "074", ctlLanguage.eumType.Tag)
        oListItem.Value = "30"
        cboStatus.Items.Add(oListItem)

        oListItem = New ListItem
        oListItem.Text = _oLanguage.getText("RMA2", "075", ctlLanguage.eumType.Tag)
        oListItem.Value = "35"
        cboStatus.Items.Add(oListItem)

        oListItem = New ListItem
        oListItem.Text = _oLanguage.getText("RMA2", "076", ctlLanguage.eumType.Tag)
        oListItem.Value = "40"
        cboStatus.Items.Add(oListItem)

        oListItem = New ListItem
        oListItem.Text = _oLanguage.getText("RMA2", "077", ctlLanguage.eumType.Tag)
        oListItem.Value = "50"
        cboStatus.Items.Add(oListItem)

        oListItem = New ListItem
        oListItem.Text = _oLanguage.getText("RMA2", "078", ctlLanguage.eumType.Tag)
        oListItem.Value = "60"
        cboStatus.Items.Add(oListItem)

        oListItem = New ListItem
        oListItem.Text = _oLanguage.getText("RMA2", "079", ctlLanguage.eumType.Tag)
        oListItem.Value = "70"
        cboStatus.Items.Add(oListItem)

        oListItem = New ListItem
        oListItem.Text = _oLanguage.getText("RMA2", "080", ctlLanguage.eumType.Tag)
        oListItem.Value = "90"
        cboStatus.Items.Add(oListItem)

        oListItem = New ListItem
        oListItem.Text = _oLanguage.getText("RMA2", "081", ctlLanguage.eumType.Tag)
        oListItem.Value = "91"
        cboStatus.Items.Add(oListItem)
