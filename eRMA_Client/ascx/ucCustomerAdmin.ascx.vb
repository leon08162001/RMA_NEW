...
#End Region
    ...
    Private Sub QueryByCustomer()
        ...
        If dtCustomer.Count > 0 Then
            ...
            '20230921 開啟終端客戶
            'EndUser Paypal 付款
            Dim oRequested_ As New ctlRMA.Requested
            Dim dt As DataTable = oRequested_.IsEndUser(Me.ViewState("_CuNo").ToString().Trim(), "X0091")
            If (dt.Rows.Count > 0) Then
                EndUser_CheckBox.Checked = True
            Else
                Dealer_CheckBox.Checked = True
            End If
    ...
    Protected Sub UI_cmdSubmit_Company_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles UI_cmdSubmit_Company.Click
        ...
        Try
            ...
            '20230921EndUser 修改
            Dim ctlCustomer_EndUser As New ctlCustomer.CustomerUser
            Dim check As Boolean
            Dim _UserID As String

            _UserID = Me.UI_txtCustomerID.Text.Trim()

            If Dealer_CheckBox.Checked = True And EndUser_CheckBox.Checked = False Then
                check = False
            ElseIf EndUser_CheckBox.Checked = True And Dealer_CheckBox.Checked = False Then
                check = True
            End If
            ...
            If Me.ViewState("_eumCommand") = eumCommand.AddNew Then
                ...
                ctlCustomer_EndUser.Update_Dealer_EndUser(check, _UserID)
            Else
    ...
    Protected Sub Dealer_CheckBox_CheckedChanged(sender As Object, e As EventArgs) Handles Dealer_CheckBox.CheckedChanged
        EndUser_CheckBox.Checked = False
    End Sub
    Protected Sub EndUser_CheckBox_CheckedChanged(sender As Object, e As EventArgs) Handles EndUser_CheckBox.CheckedChanged
        Dealer_CheckBox.Checked = False
    End Sub
End Class
