<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Shipment_Print.aspx.vb" Inherits="Shipment_Print" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <asp:Label ID="UI_lblPreviousPage_RMASM_ID" runat="server" Visible="false"></asp:Label>
</asp:Content>
