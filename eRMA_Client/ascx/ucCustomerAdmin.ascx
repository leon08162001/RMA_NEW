...
<table border="0"  id="table4" cellspacing="0" cellpadding="0"  class="table"  style="margin-top:5px;padding-top:5px;position:absolute;top:250px;">
	<tr>
	    <td width="24" >&nbsp;</td>
	    <td valign="top" align="left">
	        <table border="0" cellspacing="0" cellpadding="0"  class="table" >
	            ...
	            <tr>
	                <td>&nbsp;</td>
	                <td align="left">
	                    <table  align="center" border="0" cellspacing="1"  	class="table" >
			                <tr>
			                    <td colspan="5">&nbsp;</td>
			                </tr>
			                <tr>
			                ...
			                <tr>
			                    ...
			                    <td>:
			                        <asp:TextBox ID="UI_txtTEL" runat="server" Width="400"></asp:TextBox>　
					            </td>
			                    ...
			                    <td>:
			                        <asp:TextBox ID="UITxt_CU_TIPTOP_ID" runat="server" Width="100" MaxLength="20" readonly="true" ></asp:TextBox>　<%--style="background-color: #787878; color:#BDC0BA;"--%></td>
                                <td align="right">&nbsp;</td>
			                </tr>
			                ...
			                <tr>
			                    ...
			                    <td colspan="4"> : 
					                <asp:TextBox ID="UI_txtEMail" runat="server" Width="400"></asp:TextBox>
					            </td>
			                </tr>
                            <tr>
			                    <td>&nbsp;
                            ...
                            <td colspan=4 align="left">
                                ...
                                <%--開啟終端客戶 開始--%>
                                <asp:CheckBox ID="Dealer_CheckBox" runat="server" Text="經銷商" AutoPostBack="true"  />
                                <asp:CheckBox ID="EndUser_CheckBox" runat="server" Text="EndUser" AutoPostBack="true" />
                                <%--開啟終端客戶 結束--%>
		    ...
		    <table border="0" cellspacing="0" cellpadding="0" 	class="table">
		        <tr>
	                ...
	                <td width="97%" align="left" class="default">
	                    <!--[Begin]新增資料列表-->
	                    <div align="center">
	                    <asp:GridView ID="UI_CustomerUser" runat ="server"  GridLines="None"  Cssclass="table" CellPadding ="0" CellSpacing ="1" border="0"  AutoGenerateColumns="False" >
                            <Columns>
                              <asp:TemplateField>
