...
<asp:Panel ID="UI_panel" runat="server" Width="600px" style="display:none;position:absolute">
    <div align="center">
        ...
        <tr>
             <td align="left">
                 <table>
                     <tr>
                    <td>Serial No</td>
                    <td><asp:TextBox ID="txtStart" runat="server" Width="150px"></asp:TextBox></td>
                    <td><asp:TextBox ID="txtEnd" runat="server" Width="150px" Visible="false"></asp:TextBox> </td>
                    <td><asp:Button ID="btnSnSave" runat="server" Text="Add" CssClass="Confirm" />   </td>
                    <td>
                    <asp:FileUpload ID="FileUpload1" runat="server" />
                        
                    </td>
                    <td><asp:Button ID="Excel_btn" runat="server" Text="EXCEL" /></td>
                    </tr>
