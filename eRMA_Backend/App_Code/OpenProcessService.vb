...
Public Class OpenProcessService
    ...
    <WebMethod()>
    Public Function UPD_CHARGE_QUOTED(ByVal RMACQ_EF_ID As String) As String
        ...
        Try
            ...
            myDataTable = myctlChargeQuoted.Select_RMACHARGE_QUOTED(RMACQ_EF_ID)

            If myDataTable.Rows.Count > 0 Then

                myctlChargeQuoted.Del_RMACHARGE_QUOTED(dtRMACharge_QUOTED(0)("RMACQ_RMANO").ToString().Trim())
                ...
                Dim RMACQ_EF_ID_String As String = myDataTable(0)("RMACQ_EF_ID").ToString().Trim()
                ...
                Dim retMessage As String = runSP_UPD_RMACQ(sRMACQ_RMANO, 2, RMACQ_EF_ID_String)
