...
function DownLoadFile(){
    ...
    if (Trim(html_FullFile)!=''){
		...
		for (let i = 0; i < FileName.length; i++) {
		 var FileNameString =FileName[i].split(".");
		if(FileNameString[0].length == 17)
		{
		var sURL = UI_WEBURL + UI_VisualPath + FileName[i];
		var sFeatures = "width=300,height=200,scrollbars=yes";
		var myWindow = window.open(sURL, "winDownLoad" + i, sFeatures);
		}
...
<table border="0" bgcolor="#E3D8BE" width="100%" id="table2" cellspacing="1" cellpadding="0" class="TableListdownright" align="center" >
    ...
    <tr>
        ...
        <td align="left" colspan="3" class="default">
            ...
            <asp:Button runat="server" id="html_FileUpload_Clear" Text="046_Clear File" CssClass="Message_Alert" Width="60px" height="19px" OnClientClick="return ClearFile();"/>
            ...
            <asp:Button runat="server" id="UI_butDownLoad" Text="052_DownLoad" CssClass="Message_Alert" Width="70px" height="19px"  OnClientClick="return DownLoadFile();"/>
            <br />&nbsp;&nbsp;
