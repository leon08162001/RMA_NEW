<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucMessage_UI_cmdBankTransfer.ascx.vb" Inherits="ascx_ucMessage_UI_cmdBankTransfer" %>
   ...
   <style>     
       ...
       .message-div-class center .AlertBtn{
        ...
        <div class="message-div-class">
            ...
            <asp:Panel runat="server" id="Panel_OK">
                <asp:Button ID="UI_butClose" runat ="server" Text ="008_Close" CssClass ="AlertBtn" Width="100"   />
                <asp:HyperLink ID="HyperLink1"  BorderStyle="Solid" runat="server"  Target="_blank" Width="80" CssClass ="AlertBtn" BorderColor="Black"></asp:HyperLink>
              
                <asp:Panel ID="Panel1" runat="server" Visible="false">
                <asp:Button ID="UI_butOK" runat ="server" Text ="014_OK" CssClass ="AlertBtn"  CausesValidation="false" />
                </asp:Panel>
            </asp:Panel>
            <asp:Panel runat="server" id="Panel_Cencel"></asp:Panel>
            ...
            <br />
            <asp:HiddenField ID="HiddenField_Panel_OK" runat="server" Value="" />
            <center>
