...
Partial Class ascx_SubMenu
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
	    ...
	    Me.trRPT3.Visible = False
		Me.trRPT4.Visible = False
		Me.trRPT11.Visible = False
		Me.trRPT12.Visible = False
    ...
    Private Sub setControls()
        ...
        'Me.UI_lblAccountText.Text = Session("_UserName").ToString()
        ...
        a1 = Session("_Identity")
        a1 = Session("_CustomerID")
        a1 = Session("_RepairName")
        a1 = Session("_RepairTEL")

        a1 = Session("_UserID")
        a1 = Session("_UserName")
        a1 = Session("_DeptNO")
        a1 = Session("_isManager")

        a1 = Session("_Role")
        a1 = Session("_OperationRole")
        a1 = Session("_OperationRoleName")

        a1 = Session("_RepairCenter")
        a1 = Session("_AuthorityLevel")
        a1 = Session("_LanguageID")
        a1 = Session("_isPolicy")
