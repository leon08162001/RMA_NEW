...
#End Region
    ...
    Private Sub QueryData(ByVal iPageIndex As Integer)
        ...
        For i = 0 To Me.UI_cboRepairCenter.Items.Count - 1
            ...
            End If
        Next
        dtRequest = oClient.Query(sRMANo, sCustomerName, sModelNo, sSerial, sRepair, sStatus, fdate, edate, RepairCenter, sExpireStatus, "RMAD_RMANO desc")
