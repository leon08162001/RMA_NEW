var calendar = {
                ...
                if (i == 0) {
                    if (firstDay > j) {
                        ...
                        if (m == currMon && currDay == _d && currYear == y) {
                            ...
                            calDay.push("<td date='" + _dx + "' title='" + _d + "號' class='_sday'>" + _d + "</td>");
                        }
                        else if (f !== "") {
    ...
    init: function (s) {
        ...
        _c.push("<div id='calendar_head' class='calendar_head'><em class='calendaremL'></em><input id='_calyear' type='text' value='" + currYea + "'    title='Year'  /><input id='_calmod' type='text' value='" + currMon + "'    title='Month' /><em class='calendaremR'></em>");
        _c.push(_yers.join(""));
         _c.push("<table style='display:none;' id='calMonth' class='calMonth'><tr><td>Jan</td><td>Feb</td><td>Mar</td><td>Apr</td></tr><tr><td>May</td><td>Jun</td><td>Jul</td><td>Aug</td></tr><tr><td>Sep</td><td>Oct</td><td>Nov</td><td>Dec</td></tr></table>");
         _c.push("</div>");
        _c.push("<div class='calendar_boy' ><i id='_bgMon'>" + currMon + "</i>");
        _c.push("<table id='_tdCal' class='_caltable' border='0'><tr><td>Sun</td><td>Mon</td><td>Tue</td><td>Wed</td><td>Thu</td><td>Fri</td><td>Sat</td></tr>");
		...
		if ((calLeft + 225) > bodywidth) { calLeft = calendar.L(s) - 100; }
        ...
        $("#_calmod").click(function () {
            ...
            $("#calMonth td").click(function () {
			   ...
			   var mop =	this.innerHTML.replace(/[月]/g, "");
	...
	if(mop == "Jan")
		...
		mop = "12";
                ...
                $("#_calmod").val(mop);
                calendar._yearMon(mop, $("#_calyear").val(), s);
                $("#calMonth").hide();
            });
        }).blur(function () {
...
$(document).mouseup(function (e) {
    ...
    if (!_con.is(e.target) && _con.has(e.target).length === 0) { // Mark 1  
        var UI_calyear_Txt = document.getElementById("_calyear").value;
        var UI_calmod_Txt = document.getElementById("_calmod").value;
        var today = new Date();
        var UI_calyea_Check = "0";
        var UI_calmod_Check = "0";
        if (UI_calyear_Txt == today.getFullYear()) {
            UI_calyea_Check = "1";
        }

        if (UI_calmod_Txt == today.getMonth() +1) {
            UI_calmod_Check = "1";
        }

        if (UI_calyea_Check == "1" && UI_calmod_Check == "1") {
            $(".calendar").remove();
        }
        else {
