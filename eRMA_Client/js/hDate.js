var calendar = {
    ...
    init: function (s) {
        ...
        _c.push("<div id='calendar_head' class='calendar_head'><em class='calendaremL'></em><input id='_calyear' type='text' value='" + currYea + "'   title='年'  /><input id='_calmod' type='text' value='" + currMon + "'   title='月'    /><em class='calendaremR'></em>");
        _c.push(_yers.join(""));
