<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucProductGroup.ascx.vb" Inherits="ascx_ucProductGroup" %>
...
<asp:Panel ID="UI_panel" runat="server" style="display:none;position:absolute;width:70%;border:3px solid #808080;background:#ffffff;" >
    ...
    <table border="0"  id="table1" cellspacing="1" cellpadding="0" class="default" align="center" style="margin-top:30px;"  class="table" >
		    <tr>
		      <td align="left">
		           <asp:Label ID="lblModel" runat="server" Text="Model"></asp:Label>:
                  <asp:TextBox ID="txtModel" runat="server" Width="100px"></asp:TextBox> 
                   <asp:Button ID="UI_cmdSearch" runat="server" Text="Search" CssClass="Search"></asp:Button>
            </td>
		    </tr>
    </table>    
    <table id="table2" class="table"  align="center" border="0" cellspacing="1" >
        <tr class="default">
            <td align="left">
            ...
            <td align="center">
                <div align="center">
                    <asp:GridView ID="UI_dvAddress" runat ="server" Width = "100%" CellPadding ="0" CellSpacing ="1" border="0" CssClass="default" AutoGenerateColumns="False" AllowPaging="true" PagerSettings-Mode="Numeric"  >
                        ...
                        <asp:TemplateField HeaderText="Mode lNo">
