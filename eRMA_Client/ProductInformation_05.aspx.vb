...
Partial Class ProductInformation_05
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Me.IsPostBack = False Then
                ...
                'RMA開單後送出，print new畫面只有澳洲有上面的取件公告，日本紐西蘭不用 modify 20250801 by buck
    ...
    Private Sub setControls()
        ...
        If (Session("_RepairID").ToString = "JP_BYTE" OrElse Session("_RepairID").ToString = "AU" OrElse Session("_RepairID").ToString = "NZ_PB_TECH") Then
            Me.NoteLab.Text = ""
        Else
            Me.NoteLab.Text = _oLanguage.getText("RMA2", "035", ctlLanguage.eumType.Tag)
        End If
    End Sub
    ...
    Private Sub Print(ByVal dtReport As RmaDTO.RequestReportDataTable, ByVal EndUser As Boolean, ByVal PartsRequest As Boolean, ByVal sLanguageID As String)
        ...
        If (Session("_RepairID").ToString() = "JP_BYTE" OrElse
            ...
            Session("_RepairID").ToString() = "AU_LAPTOP_KINGS") Then
            check_bool = True
        End If
        ...
        End If
        'LogHelper.WriteLog(Server_MapPath_rpt)
