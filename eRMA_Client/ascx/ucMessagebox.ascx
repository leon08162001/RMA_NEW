<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucMessagebox.ascx.vb" Inherits="ascx_ucMessagebox" %>
...
<asp:Panel ID="panelMessage" runat="server"  style="display:none;position:absolute;">
   <style>
       ...
       .message-div-class center .AlertBtn{
        ...
        <table style="background:#fff;border-radius:10px;width:400px;height:380px;border:none;padding:10px;">
        <tr>
        <td>
