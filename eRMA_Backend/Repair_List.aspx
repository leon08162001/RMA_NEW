<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Repair_List.aspx.vb" Inherits="Repair_List" Title="Untitled Page" %>
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="UI_isPrintQuotedFRBH" runat="server" Text='<%# Eval("isPrintQuotedFRBH") %>' Visible="false"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
