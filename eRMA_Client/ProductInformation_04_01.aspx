<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProductInformation_04_01.aspx.vb" Inherits="ProductInformation_04_01" %>
...
<head runat="server">
    ...
    <script>
        function Checking_ProductInformation_04() {
            ...
            var UI_lblAccountNameText_txt = document.getElementById('<%= UI_lblAccountNameText.ClientID %>');
            var art = "";

            if (UI_lblAccountNameText_txt.value == "") {
                art += '<%= CheckingAlert("126") %>  \r\n';
            }
    ...
    <style id="inert-style">
        ...
        .erma-window-newRequest-clientInfo-background .erma-window-box .erma-warranty-divcontent tr .erma-textBox-UI_txtRemark {
            resize: none;
            height: 5vh;
        }
    </style>
...
<body>
    <form id="form1" runat="server" onkeydown="if(event.keyCode==13)return false;">
        ...
        <div class="erma-window-background erma-window-newRequest-clientInfo-background" style="width: 100%; background: #fff; overflow: auto;">
            <div class="erma-window-box" style="width: 100%;">
                <div>

                    <h7>
                        <asp:Label ID="ClientInformationLab" runat="server" Text="Client Information"></asp:Label>
                    </h7>
                ...
                <div class="erma-box-content" style="position: relative;">
                    <div class="erma-warranty-divtop">

                        <asp:Label ID="ComprehensiveWarrantyLabel" runat="server" Text="" Font-Size="Larger"></asp:Label>
                        <div class="erma-buttons-div erma-top-buttons-div">
                            <asp:Button ID="BackBtn" runat="server" Text="Back" CssClass="BackBtn" OnClick="BackBtn_Click" OnClientClick="ShowProgressBar();" />
                        </div>
                    </div>
                    <div class="erma-warranty-divcontent">
                        <table width="100%">
                            <tr>
                                <td>
                                    <asp:Label ID="UI_lblAccountID" runat="server" Text="003_* Account ID" Visible="false"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>*<asp:Label ID="UI_lblAccountName" runat="server" Text="004_* Account Name"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="UI_lblAccountNameText" runat="server" CssClass="erma-input-input"></asp:TextBox>

                                </td>
                            </tr>

                            <tr>
                                <td>*<asp:Label ID="UI_lblApplicant" runat="server" Text="006_* Applicant"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>*<asp:Label ID="UI_lblTel" runat="server" Text="007_* Tel No."></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>*<asp:Label ID="UI_lblMail" runat="server" Text="044_Mail"></asp:Label></td>
                                <td>
                            ...
                            <tr>
                                <td>*<asp:Label ID="UI_lblAddress" runat="server" Text=""></asp:Label>
                                    :</td>
                                <td>
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="erma-newRequest-combobox erma-combobox-control">
                                                    ...
                                                    <asp:DropDownList ID="ddlDiv" runat="server" Width="165" CssClass="erma-combobox-choose">
                                                    </asp:DropDownList>
                                            ...
                                            <td>
                                                <div class="erma-newRequest-combobox erma-combobox-control">
                                                    <asp:TextBox ID="UI_txtCountry" runat="server" Width="165" CssClass="erma-input-input" placeholder="City"></asp:TextBox>

                                                </div>
                                            </td>
                                            <td style="visibility: hidden">
                                                <!-- asp:Panel是隱藏元件用的 -->
                                                <asp:Panel ID="UI_dvRMAAddress_ddlVil_Panel" runat="server" Visible="false">
                                                    <div class="erma-newRequest-combobox erma-combobox-control">
                                                        <asp:DropDownList ID="ddlVil" runat="server" AutoPostBack="true" Width="165" CssClass="erma-combobox-choose">
                                                        </asp:DropDownList>
                                                    </div>
                                                </asp:Panel>
                                                <asp:Panel ID="UI_dvRMAAddress_ddlCityarea_Panel" runat="server" Visible="false">
                                                    <div class="erma-newRequest-combobox erma-combobox-control">
                                                        <asp:DropDownList ID="ddlCityarea" runat="server" Width="165" CssClass="erma-combobox-choose">
                                                        </asp:DropDownList>
                                                    </div>
                                                </asp:Panel>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="erma-newRequest-combobox erma-combobox-control">
                                                    <asp:TextBox ID="UI_txtCode" runat="server" CssClass="erma-input-input" placeholder="Postcode"></asp:TextBox>
                                                </div>
                                            </td>
                                            <td colspan="2">
                                                <div class="erma-newRequest-combobox erma-combobox-control">
                                                    <asp:TextBox ID="UI_txtAddress" runat="server" CssClass="erma-input-input" placeholder="address"></asp:TextBox>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:TextBox runat="server" ID="UI_txtRemark" CssClass="erma-textBox-UI_txtRemark" TextMode="MultiLine" Rows="4" Columns="50" MaxLength="1500"></asp:TextBox>
                ...
                <div class="erma-buttons-div">
                    ...
                    <asp:Button ID="ErmaButtonBackBackBtn" runat="server" Text="Back" CssClass="ErmaButtonBackBackBtn" OnClick="ErmaButtonBackBackBtn_Click" Width="90" Height="40" />
...
<script>
    if ($(window).height() <= 768) {
        $(".erma-warranty-divcontent").css({ 'height': '65vh', 'overflow': 'auto' });
