<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Sale_WorkList.aspx.vb" Inherits="Sale_WorkList" Title="Untitled Page" %>
                        ...
                        <table border="0" width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="50%" align="right" class="default">
                                    <asp:Label ID="UI_lblQuickSearch" runat="server" Text="069_Quick search" Visible="false"></asp:Label>:
			                <asp:DropDownList ID="UI_cboQuickSearch" runat="server" AutoPostBack="true" Visible="false"></asp:DropDownList>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </td>
                            </tr>
                        </table>
                        ...
                        <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <asp:GridView ID="UI_dvSales" runat="server" Width="100%" CellPadding="0" CellSpacing="1" border="0" CssClass="default" AutoGenerateColumns="False" AllowPaging="true" PagerSettings-Mode="Numeric">
                                            <Columns>
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="UI_Check" runat="server" Visible="false" AutoPostBack="true" OnCheckedChanged="UI_check_CheckedChanged" />
                                                ...
                                                <asp:BoundField DataField="CU_NAME" HeaderText="036_Client" HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                                                ...
                                                <asp:TemplateField HeaderText="029_RMA No">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="UI_RMADNO" runat="server" Text='<%# Eval("RMAD_RMANO") %>' CommandName="cmdDetail" CommandArgument='<%# me.UI_dvSales.Rows.Count%>' PostBackUrl="RMARepair_UpLoad.aspx"></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:BoundField DataField="QUOTE" HeaderText="070_Quote" HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                                                ...
                                                <asp:TemplateField HeaderText="037_Amount">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <%--                                                <asp:RequiredFieldValidator ID="rfvSaleQuote" runat="server" ErrorMessage="135_請輸入費用加總"  Display="None" TabIndex="0" ValidationGroup="SaleSaveGroup" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                                        <%--                                                <asp:RangeValidator ID="rvSaleQuote" runat="server" ErrorMessage="136_輸入費用加總型態有誤"  Display="None" MinimumValue="0" MaximumValue="10000" Type="Double" ValidationGroup="SaleSaveGroup" SetFocusOnError="true"></asp:RangeValidator>--%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <br />
                                    <asp:Button ID="UI_cmdSave" runat="server" Text="002_Save" CssClass="Confirm_l" ValidationGroup="SaleSaveGroup" Visible="false" />
                                    <input id="UI_cmdCancel" runat="server" type="button" value="010_Cancel" class="Problem_Edit" onclick="javascript:history.back();" visible="false" />&nbsp;
	                        <asp:Button ID="UI_cmdSubmit" runat="server" Text="040_Submit to Customer" CssClass="Confirm_l" OnClientClick="onProgress('Process')" />
                                    <asp:Button ID="UI_cmdConfirm" runat="server" Text="041_Confirm by Sales" CssClass="Confirm_l" OnClientClick="onProgress('Process')" />
                                </td>
                            </tr>
                        </table>
                    </td>
