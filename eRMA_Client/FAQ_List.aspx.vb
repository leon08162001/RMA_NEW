...
#Region "Page_Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Me.IsPostBack = False Then
            ...
            dtFAQ = Session("_dtFAQ")
            BookMark_Label.Value = "0"
            Current_Page_Label.Text = "1"
            Dim myDecimal As Decimal = dtFAQ.Rows.Count / _PageSize
...
#Region "setControls"
    Private Sub setControls()
        ...
        Me.UI_lblBack.Text = _oLanguage.getText("Common", "006", ctlLanguage.eumType.Command)
        Me.UI_txtQuestion.Attributes.Add("placeholder", _oLanguage.getText("Common", "016", ctlLanguage.eumType.Command))
    End Sub
#End Region
...
#Region "頁"
    Protected Sub first_ImageBtn_Click(sender As Object, e As ImageClickEventArgs) Handles first_ImageBtn.Click
        ...
        Dim myDataTable As New FaqDTO.FAQDataTable
        myDataTable = Session("_dtFAQ")

        Me.UI_dvFAQ.PageSize = _PageSize
        Dim myDecimal As Decimal = myDataTable.Rows.Count / _PageSize
        Me.UI_dvFAQ.PageIndex = 0
        Me.UI_dvFAQ.DataSource = myDataTable
        Me.UI_dvFAQ.DataBind()
        BookMark_Label.Value = "0"
        Current_Page_Label.Text = "1"
    End Sub
    Protected Sub previous_ImageBtn_Click(sender As Object, e As ImageClickEventArgs) Handles previous_ImageBtn.Click
        ...
        Me.UI_dvFAQ.PageSize = _PageSize
        Dim myDecimal As Decimal = myDataTable.Rows.Count / _PageSize
        If Convert.ToInt32(BookMark_Label.Value.Trim()) > 0 Then
            Me.UI_dvFAQ.PageIndex = Convert.ToInt32(BookMark_Label.Value.Trim()) - 1
            BookMark_Label.Value = (Convert.ToInt32(BookMark_Label.Value.Trim()) - 1).ToString()
    ...
    Protected Sub next_ImageBtn_Click(sender As Object, e As ImageClickEventArgs) Handles next_ImageBtn.Click
        ...
        Me.UI_dvFAQ.PageSize = _PageSize
        Dim myDecimal As Decimal = myDataTable.Rows.Count / _PageSize
        If Convert.ToInt32(BookMark_Label.Value.Trim()) < Math.Ceiling(myDecimal) - 1 Then
            Me.UI_dvFAQ.PageIndex = Convert.ToInt32(BookMark_Label.Value.Trim()) + 1
            BookMark_Label.Value = (Convert.ToInt32(BookMark_Label.Value.Trim()) + 1).ToString()
            Current_Page_Label.Text = (Convert.ToInt32(Current_Page_Label.Text.Trim()) + 1).ToString()
        End If
    ...
    Protected Sub last_ImageBtn_Click(sender As Object, e As ImageClickEventArgs) Handles last_ImageBtn.Click
        ...
        Me.UI_dvFAQ.PageSize = _PageSize
        Dim myDecimal As Decimal = myDataTable.Rows.Count / _PageSize
        Me.UI_dvFAQ.PageIndex = Math.Ceiling(myDecimal)
        Me.UI_dvFAQ.DataSource = myDataTable
        Me.UI_dvFAQ.DataBind()
        BookMark_Label.Value = Me.UI_dvFAQ.PageIndex.ToString()
        Current_Page_Label.Text = (Me.UI_dvFAQ.PageIndex + 1).ToString()
    End Sub
    Protected Sub Current_Page_Label_TextChanged(sender As Object, e As EventArgs) Handles Current_Page_Label.TextChanged
        ...
        If IsNumeric(Current_Page_Label.Text.Trim()) Then
            ...
            If Convert.ToInt32(Current_Page_Label.Text.Trim()) - 1 <= Math.Ceiling(myDecimal) - 1 And Convert.ToInt32(Current_Page_Label.Text.Trim()) > 0 Then
                Me.UI_dvFAQ.PageIndex = Convert.ToInt32(Current_Page_Label.Text.Trim()) - 1
                BookMark_Label.Value = (Convert.ToInt32(Current_Page_Label.Text.Trim()) - 1).ToString()
