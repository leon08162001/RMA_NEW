...
<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" class="TableListdownright">
		<tr>
		...
		<tr>
			<td valign="top" bgcolor="#E3D8BE" align="center" height="20px">
                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="default" >
                    <tr>
                        <td width="10%" align="right">
                            ...
                            <asp:GridView ID="UI_dvFAQSubClass" runat ="server" Width = "100%" CellPadding ="0" CellSpacing ="1" border="0" CssClass="default" AutoGenerateColumns="False" AllowPaging="true" PagerSettings-Mode="Numeric" >
                                <Columns>
                                  <asp:TemplateField>
                                     ...
                                     <ItemStyle HorizontalAlign="Center" CssClass="text9pt" Height="25px"></ItemStyle>
                                     <ItemTemplate>
                                            <asp:Label ID ="lblSeqID" runat = "server" text='<%# me.UI_dvFAQSubClass.Rows.Count +1 %>'></asp:Label>
        ...
        <tr>
			<td align="center" bgcolor="#E3D8BE" align="center" height="35px">
