<%@ Control Language="VB" AutoEventWireup="false" CodeFile="UcSDCView.ascx.vb" Inherits="ascx_UcSDCView" %>

<asp:Panel ID="UI_panel" runat="server" Width="800px" style="display:none;position:absolute;width:70%;border:3px solid #808080;background:#ffffff;">
                ...
                <table id="table2" width="100%" height="100%" align="center" border="0" cellspacing="1" >  
	                ...
	                <tr class="default" valign="top">
	                    <td align="left" colspan="4">
                                                <asp:GridView ID="dgvSDC" runat="server" CssClass="default" Width="100%" PagerSettings-Mode="Numeric" AllowPaging="true" AutoGenerateColumns="False" border="0"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="AST_TYPENAME" HeaderText="AST_TYPENAME"
                                                            HeaderStyle-Width="12%" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
