...
<asp:Panel ID="UI_panel" runat="server" Width="800px" style="display:none;position:absolute;background:#ffffff;border:3px solid #808080;">
    <div align="center">

    <fieldset class = "form_div" align="top" style="width: 100%">
    <table border="0" width="95%" id="table1" cellspacing="1" cellpadding="0" class="table" align="center" style="margin-top:30px;">
		<tr>
		  <td align="left">
    ...
    <table id="table2"  align="center" border="0" cellspacing="1"  class="table" >
        <tr class="default">
            <td align="left">
