...
<script type="text/javascript">
    ...
    <table id="table2"  align="center" border="0" cellspacing="1"  class="table" >
        ...
        <tr  valign="top">
            <td align="center">
                <asp:GridView ID="UI_dvCustomer" runat ="server"  CellPadding ="0" CellSpacing ="1" border="0" Cssclass="table" AutoGenerateColumns="False" AllowPaging="true" PagerSettings-Mode="Numeric">
                    <Columns>
                      <asp:TemplateField>
