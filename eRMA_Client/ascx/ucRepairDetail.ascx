<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucRepairDetail.ascx.vb" Inherits="ascx_ucRepairDetail" %>
...
<asp:Panel ID="UI_panel" runat="server" style="display:none;position:absolute;width:70%;border:3px solid #808080;background:#ffffff;">
    ...
    <table id="table1"  class="table"  style="width:100%;" align="center" border="0" cellspacing="1" >
        <tr valign="top">
            <td align="center">

<fieldset class="form_div" align="top" style="width:97%">
                ...
                <table id="table2" width="100%" height="100%" align="center" border="0" cellspacing="1" >
	                ...
	                <tr class="default"  runat="server" id="uiTR_Charge">
                    ...
                    <tr class="default" runat="server" id="uiTR_beforeCost">
                        <td align="left" width="40%">
                            <asp:Label ID="UI_lblbefore" runat="server" Text="192_QuoteBefore" Font-Bold="true"></asp:Label>:
                            &nbsp;&nbsp;
                            <asp:Label ID="UI_lblLaborCost_Before" runat="server" Text="125_Labor Cost" Font-Bold="true"></asp:Label>:
                            <asp:Label ID="UI_lblLaborCostText_Before" runat="server" Font-Underline="true"></asp:Label>
                        </td>
                        <td align="left" width="30%">
                            <asp:Label ID="UI_lblMaterialCost_Before" runat="server" Text="126_Material Cost" Font-Bold="true"></asp:Label>:
                            <asp:Label ID="UI_lblMaterialCostText_Before" runat="server" Font-Underline="true"></asp:Label>
                        </td>
                        <td colspan="2" align="left" width="30%">
                            <asp:Label ID="UI_lblTotalAmount_Before" runat="server" Text="127_Total Amount" Font-Bold="true"></asp:Label>:
                            <asp:Label ID="UI_lblTotalAmountText_Before" runat="server" Font-Underline="true"></asp:Label>
                        </td>
                    </tr>
	                  
                    <tr class="default" runat="server" id="uiTR_afterCost">
                        <td align="left" width="40%">
                            <asp:Label ID="UI_lblAfter" runat="server" Text="193_QuoteAfter" Font-Bold="true"></asp:Label>:
                            &nbsp;&nbsp;
                            <asp:Label ID="UI_lblLaborCost_After" runat="server" Text="125_Labor Cost" Font-Bold="true"></asp:Label>:
                            <asp:Label ID="UI_lblLaborCostText_After" runat="server" Font-Underline="true"></asp:Label>
                        </td>
                        <td align="left" width="30%">
                            <asp:Label ID="UI_lblMaterialCost_After" runat="server" Text="126_Material Cost" Font-Bold="true"></asp:Label>:
                            <asp:Label ID="UI_lblMaterialCostText_After" runat="server" Font-Underline="true"></asp:Label>
                        </td>
                        <td colspan="2" align="left" width="30%">
                            <asp:Label ID="UI_lblTotalAmount_After" runat="server" Text="127_Total Amount" Font-Bold="true"></asp:Label>:
                            <asp:Label ID="UI_lblTotalAmountText_After" runat="server" Font-Underline="true"></asp:Label>
                        </td>
                    </tr>
                                    ...
                                    <table width="100%" border="0" cellspacing="5" cellpadding="1">
                                        <tr valign="top" align ="left" height ="20px">
                                            <td width="33%" align="left">
                                                ...
                                                <asp:Label ID="UI_lblRepair1" runat="server" Text='<%# Eval("RMARU_DESC_1") %>' Visible="false"></asp:Label>&nbsp;
                                            ...
                                            <td width="33%" align="left">
                                                ...
                                                <asp:Label ID="UI_lblRepair2" runat="server" Text='<%# Eval("RMARU_DESC_2") %>' Visible="false"></asp:Label>&nbsp;
                                             ...
                                             <td width="34%" align="left">
                                                ...
                                                <asp:Label ID="UI_lblRepair3" runat="server" Text='<%# Eval("RMARU_DESC_3") %>' Visible="false"></asp:Label>&nbsp;
