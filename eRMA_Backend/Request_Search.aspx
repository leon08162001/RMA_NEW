<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Request_Search.aspx.vb" Inherits="Request_Search" Title="Untitled Page" %>
                            ...
                            <asp:Panel runat="server" ID="UI_panSearch" DefaultButton="UI_cmdSearch">
                                <table width="95%" border="0" cellspacing="1" cellpadding="0" class="default">
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">
                                            <asp:Label ID="UI_lblExpired" runat="server" Text="Expired"></asp:Label>
                                        </td>
                                        <td align="left">:
                                            <asp:DropDownList ID="UI_cboExpireStatus" runat="server">
                                                ...
                                                <%--'多語系調整 by buck modify 20251201 end--%>
                                                    <asp:ListItem Text="未過期" Value="0"></asp:ListItem>
                                                    <asp:ListItem Text="已過期" Value="1"></asp:ListItem>
                                            </asp:DropDownList>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
