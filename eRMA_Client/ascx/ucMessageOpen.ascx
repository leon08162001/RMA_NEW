<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucMessageOpen.ascx.vb" Inherits="ascx_ucMessageOpen" %>

<!-- 提示訊息 STRAT -->
<asp:Panel ID="panelMessage" runat="server"  style="display:none;position:center;">
   <style>
       ...
       .message-div-class center .AlertBtn{
        ...
        <table style="background:#fff;border-radius:10px;width:400px;height:380px;border:none;">
        <tr>
        <td>
