<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucSKU.ascx.vb" Inherits="ascx_ucSKU" %>

<asp:Panel ID="UI_panel" runat="server" Width="500px" style="display:none;position:absolute;width:70%;border:3px solid #808080;background:#ffffff;">
    <div align="center">
    <fieldset class = "form_div" align="top" style="width: 100%">
    <table id="table2" width="100%" align="center" border="0" cellspacing="1" >
        <tr class="default">
            <td align="left">
                <asp:Label ID="UI_lblAddressTittle" runat ="server" Text="055_Please pick one product group from below lists and get window closed."></asp:Label>
            </td>
        </tr>
            ...
            <td align="center">
                <div align="center">
                    <asp:GridView ID="UI_dvAddress" runat ="server" Width = "100%" CellPadding ="0" CellSpacing ="1" border="0" CssClass="default" AutoGenerateColumns="False" AllowPaging="true" PagerSettings-Mode="Numeric"  >
                        ...
                        <asp:TemplateField HeaderText="056_Product Gruop">
                             ...
                             <ItemTemplate>
                                    <asp:Label runat="server" ID="UI_CUAddress" Text='<%# Eval("GroupNo") %>'></asp:Label>
                             </ItemTemplate>
                          </asp:TemplateField>        
 
                          
                        <asp:TemplateField HeaderText="057_Description">
                             <HeaderStyle Width="60%" Height ="20px" HorizontalAlign="Center"></HeaderStyle>
                             <ItemStyle HorizontalAlign="left" CssClass="text9pt" Height="25px"></ItemStyle>
                             <ItemTemplate>
                                    <asp:Label runat="server" ID="UI_CUAddress1" Text='<%# Eval("GroupName") %>'></asp:Label>
                             </ItemTemplate>
                          </asp:TemplateField>    
